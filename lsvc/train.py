...
if __name__ == "__main__":
	# Dataset flags.
	flags.DEFINE_string("train_dir", "/usr/dataset/frame",
	...
	flags.DEFINE_string("feature_names", "frame_feature", "Name of the feature "
	                                                 "to use for training.")
	flags.DEFINE_string("feature_sizes", "4096", "Length of the feature vectors.")
	...
	flags.DEFINE_float("learning_rate_decay_examples", 60000,
...
def get_input_data_tensors(reader,
	...
	with tf.name_scope("train_input"):
		...
		logging.info("training data : " + str(training_data[0][1]) )
...
class Trainer(object):
	...
	def __init__(self, cluster, task, train_dir, model, reader, model_exporter,
		...
		self.config = tf.ConfigProto(log_device_placement=log_device_placement, allow_soft_placement=True)
		# Add
...
def get_reader():
	...
	if FLAGS.frame_features:
		reader = readers.LSVCFrameFeatureReader(
			feature_names=feature_names, feature_sizes=feature_sizes)
	else:

		reader = readers.LSVCAggregatedFeatureReader(
			feature_names=feature_names, feature_sizes=feature_sizes)
